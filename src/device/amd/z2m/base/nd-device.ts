...
import { Debuger, DeviceBaseAttr } from "../../../device-base";
import { Base, IBase, IDeviceBaseAttr, IDeviceBusDataPayload, IDeviceBusEventData } from "../../../device.dts";
...
export interface IZigbee2Mqtt extends INDDevice {
    z2m: IZ2M ;
...
export class Z2MTcpServer extends Base implements IZ2MTcpServer {
    ...
    initSocket() {
        ...
        socket.on("data", (data: Buffer) => {
            ...
            this.events.output.data.emit(data);
...
export class Zigbee2Mqtt extends NDDevice implements IZigbee2Mqtt {
    z2m: IZ2M;
    mqtt: IZ2MMqtt;    
    config: IZigbee2MqttConfig
    ...
    on_child_input(msg: IDeviceBusEventData) {
        ...
        Debuger.Debuger.log("Zigbee2Mqtt  on_child_input 2", msg);
...
//Mqtt南向输出
    on_mqtt_south_output(msg: IDeviceBusEventData) {
        Debuger.Debuger.log("Zigbee2Mqtt on_mqtt_south_output");
